...
void BattlegroundWS::StartingEventCloseDoors()
{
    ...
    SpawnBGObject(BG_WS_OBJECT_DOOR_H_5, RESPAWN_ONE_DAY);
    SpawnBGObject(BG_WS_OBJECT_DOOR_H_6, RESPAWN_ONE_DAY);
...
bool BattlegroundWS::SetupBattleground()
{
    ...
    if (!AddObject(BG_WS_OBJECT_A_FLAG, BG_OBJECT_A_FLAG_WS_ENTRY, 1540.423f, 1481.325f, 351.8284f, 3.089233f, 0, 0, 0.9996573f, 0.02617699f, BG_WS_FLAG_RESPAWN_TIME/1000)
        ...
        || !AddObject(BG_WS_OBJECT_DOOR_A_5, BG_OBJECT_DOOR_A_5_WS_ENTRY, 1520.848f, 1454.429f, 361.7027f, 3.115414f, 0, 0, 0.9999143f, 0.01308903f, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_WS_OBJECT_DOOR_A_6, BG_OBJECT_DOOR_A_6_WS_ENTRY, 1516.494f, 1447.793f, 373.2104f, 4.579351f, 0, 0, 0.9999143f, 0.01308903f, RESPAWN_IMMEDIATELY)
        // horde gates
        ...
        || !AddObject(BG_WS_OBJECT_DOOR_H_3, BG_OBJECT_DOOR_H_3_WS_ENTRY, 984.2130f, 1422.604f, 345.4384f, 0.002808f, 0, 0, 0.02617695f, 0.9586737f, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_WS_OBJECT_DOOR_H_4, BG_OBJECT_DOOR_H_4_WS_ENTRY, 981.5242f, 1458.540f, 356.2153f, 0.002808f, 0, 0, 0.02617695f, 0.9586737f, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_WS_OBJECT_DOOR_H_5, BG_OBJECT_DOOR_H_5_WS_ENTRY, 932.7781f, 1462.182f, 355.4328f, 0.002808f, 0, 0, 0.02617695f, 0.9586737f, RESPAWN_IMMEDIATELY)
        || !AddObject(BG_WS_OBJECT_DOOR_H_6, BG_OBJECT_DOOR_H_6_WS_ENTRY, 936.7243f, 1469.534f, 367.2883f, 1.594207f, 0, 0, 0.02617695f, 0.9586737f, RESPAWN_IMMEDIATELY)
)
    {
